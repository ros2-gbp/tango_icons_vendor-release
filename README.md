## tango_icons_vendor (jazzy) - 0.3.1-1

The packages in the `tango_icons_vendor` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy tango_icons_vendor` on `Wed, 21 Jan 2026 22:43:02 -0000`
